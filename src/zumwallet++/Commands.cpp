...
{
    return ZumUtilities::filter(allCommands(), [](AdvancedCommand c)
    {
        return !c.advanced;
    });
}
...
{
    return ZumUtilities::filter(basicCommands(), [](AdvancedCommand c)
    {
...
{
    return ZumUtilities::filter(advancedCommands(), [](AdvancedCommand c)
    {
        return c.viewWalletSupport;
    });
}
