...
//////////////////////////////////////////
#include <zumwallet++/CommandDispatcher.h>
//////////////////////////////////////////

#include <iostream>

#include <zumwallet++/AddressBook.h>
#include <Utilities/ColouredMsg.h>
#include <zumwallet++/CommandImplementations.h>
#include <zumwallet++/Open.h>
#include <zumwallet++/Transfer.h>
#include <zumwallet++/Fusion.h>
    ...
    const std::shared_ptr<std::mutex> mutex)
{
    ...
    else if (command == "optimize")
    {
        ...
        if (!ZumUtilities::confirm("Do you want to proceed?"))
        {
