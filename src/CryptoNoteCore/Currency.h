...
private:
  ...
  uint64_t baseRewardFunction(uint64_t alreadyGeneratedCoins, uint32_t height, uint64_t fee) const;
  // uint64_t baseRewardFunction(const CachedBlock& block) const;
