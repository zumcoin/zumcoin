...
function usage()
{
    ...
    echo "and generates the checksum files of the ZumCoin tag provided."
    echo
...
# -- Config
GITHUB_REPO="https://github.com/zumcoin/zumcoin.git"
CLONE_DIR="$BUILD_DIRECTORY/zumcoin-buildall"
TARGET_DIR="$BUILD_DIRECTORY/zumcoin-releases"
DYNAMIC_RELEASE="zumcoin-${TAG_VERSION}-linux-CLI"
STATIC_RELEASE="zumcoin-${TAG_VERSION}-linux-staticboost-CLI"
